...
$\qquad$ $\qquad$ $\qquad$ $=\vec{a}\cdot\vec{a}-\vec{a}\cdot\vec{b}-\vec{b}\cdot\vec{a}+\vec{b}\cdot\vec{b}$
...
$\qquad$ $\qquad$ $\qquad$  $\qquad$  $=\vec{a}\cdot\vec{a}-\vec{a}\cdot\vec{b}+\vec{b}\cdot\vec{a}-\vec{b}\cdot\vec{b}$
...
$\qquad$ $+12\times2\sqrt2\times3\times\cos45^\circ$
