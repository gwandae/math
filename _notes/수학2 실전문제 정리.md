...
<span style="color: #0892FC;">$\qquad$답: $-13$</span>

(2) $\displaystyle\lim_{x\to 3}\lbrace f(x)-2g(x)\rbrace$
<span style="color: #0892FC;">$\qquad$답: $8$</span>

(3) $\displaystyle\lim_{x\to3}4f(x)g(x)$
<span style="color: #0892FC;">$\qquad$답: $-24$</span>
...
#### 문제4. 두 함수 $f(x),\ g(x)$에 대하여 $\displaystyle\lim_{x\to\infty}f(x)=\infty,\ \displaystyle\lim_{x\to\infty}\lbrace-3f(x)+g(x)\rbrace=-14$일 때, $\displaystyle\lim_{x\to\infty}\dfrac{f(x)-2g(x)}{5f(x)+4g(x)}$의 값을 구하시오.
<span style="color: #0892FC;">$\qquad$답: $-4$</span>
...
(나) $\displaystyle\lim_{x\to n}\dfrac{f(x)}{g(x)}=(n-1)(n-2)\quad (n=1, 2, 3, 4)$

$g(5)$의 값은?
<img src="/assets/two cs/모고4.jpg"/>
<img src="/assets/two cs/모고5.jpg"/>
<span style="color: #0892FC;">$\qquad$답: $12$</span>
