...
Let $f(x)=(x+1)(x^2+ax+b)$

$\begin{aligned}\text{i) }\displaystyle\lim_{x\to-1}\dfrac{(x+1)
(x^2+ax+b)}{x+1}=1-a+b&=2 \\ -a+b&=1 \\ b&=1+a\end{aligned}$

$$\begin{aligned}\text{ii) }f(1)=2(1+a+b)\le&12 \\ a+b\le&5 \\ 2a+1\le&5 \\ a\le&2\end{aligned}$$

$\quad\begin{align*}f(2)&=3(4+2a+b)\\
&=3(4+2a+1+a)\\&\le3(4+4+1+2)=33\end{align*}$