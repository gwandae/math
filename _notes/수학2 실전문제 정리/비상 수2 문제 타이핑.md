...
직선 도로를 $20$ m/s로 달리는 어떤 장도차가 제동을 건 지 $t$초 후의 위치를 $x$ m라 하면

$x=-\dfrac{10}{3-t^2+20} t\ (0\le t\le 3)$
...
$\displaystyle\int_1^3(4-2 t)\,dt=\bigg[4t-t^2\bigg]_1^3$

(3) 

$1\le t\le 2$에서 $v(t)\ge0$, $2\le t \le 3$이므로
...
#### 문제2. 지상 $1$ m 높이에서 $10$ m/s의 속도로 지면과 수직하게 위로 던져 올린 공의 $t$초 후의 속도를 $v(t)$ m/s$라고 하면
