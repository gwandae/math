...
⑵ $\lbrace x\mid -3<x<2\text{인 정수}$

⑶ $\lbrace -1, 0, 1, 2, 3\rbrace$

⑷ $\lbrace x\mid x\text{는 28의 약수}$

## 문제4. 다음 집합을 벤 다이어그램으로 나타내시오. 

⑴ $A=\lbrace 20, 40, 60, 80\rbrace$

⑵ $B=\lbrace x\mid \text{는 10 이하의 소수}$
...
⑵ 집합 $B=\lbrace x\mid x\text{는 1보다 작은 자연수}$에서 $B=\emptyset$이고, $n(B)=0$이다.

## 문제5. 다음 세 집합 $A, B, C$에 대하여 $n(A), n(B), n(C)$ 를 구하시오. 

⑴ $A=\lbrace 3, 5, 8, 11\rbrace$

⑵ $B=\lbrace x\mid x\text{는 } x^2-6x+5\leq 0\text{인 자연수}$
