...
문제18. $x$에 대한 다항식 $x^3+(2a+3)x^2+(3a+5)x+a+3$이 $(x+b)(x+c)^2$으로 인수분해되도록 하는 세 실수 $a, b, c$에 대하여 $a+b+c$의 최댓값을 $M$, 최솟값을 $m$이라 일 때, $M+m$의 값은? [4점]



조립제법을 이용하면 

$(x+1)\Big(x^2+(2a+2)x+a+3\Big)$
