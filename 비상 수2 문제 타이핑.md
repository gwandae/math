...
#### 그래프1. 함수 $y=(x-1)(x-2)$ 그래프를 제시하는 방법대로 그리시오.

(1) 표준형

(2) 인수분해

#### 그래프2. 함수 $y=(x-1)(x-2)(x-3)$의 그래프를 그리시오.

#### 그래프3. 함수 $y=-(x-1)(x-2)(x-3)$의 그래프를 그리시오.

#### 최고차항의 부호로 오른쪽 위($+$), 오른쪽 아래($-$)를 알 수 있다.

#### 그래프4. 함수 $y=(x-1)^2(x-2)$의 그래프를 그리시오.

#### 그래프5. 함수 $y=(x-1)(x-2)^2$의 그래프를 그리시오.
