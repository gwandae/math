...
(1) $\vec{a}\cdot\vec{b}=\lvert \vec{a}\rvert\ \lvert \vec{b}\rvert\cos30^\circ$

$=2\sqrt3\times\dfrac{\sqrt3}{2}=3$

(2) $\vec{a}\cdot\vec{b}=\lvert \vec{a}\rvert\ \lvert \vec{b}\rvert\cos90^\circ$

$=2\sqrt3\times 0=0$

---

(3) $\vec{a}\cdot\vec{b}=\lvert \vec{a}\rvert\ \lvert \vec{b}\rvert\cos30^\circ$
...
오른쪽 그림과 같이 $\overline{AB}=4, \overline{AC}=5, \angle B=90^\circ$인 직각삼각형 $ABC$에서 $\vec{AB}\cdot\vec{AC}$를 구하시오.
